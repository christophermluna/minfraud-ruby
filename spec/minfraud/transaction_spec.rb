...
describe Minfraud::Transaction do
  ...
  describe 'Minfraud::Transaction.new' do
    ...
    it 'raises an exception if required attributes are not set' do
      expect { Minfraud::Transaction.new { |c| true } }.to raise_exception(Minfraud::TransactionAttributesMissingError, /required/)
    end
    ...
    it 'raises an exception if license key is left nil' do
      ...
      expect { transaction.call }.to raise_exception(Minfraud::TransactionAttributesMissingError, /required/)
    end
